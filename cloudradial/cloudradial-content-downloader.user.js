...
(function () {
  ...
  function isTokensPage() {
    return (
      window.location.pathname === "/app/admin/tokens" ||
      window.location.pathname === "/app/admin/tokens/"
    );
  }
  ...
  function isQuestionsListPage() {
    return (
      window.location.pathname === "/app/admin/questions" ||
      window.location.pathname === "/app/admin/questions/"
    );
  }
  ...
  function getContentTitle() {
    try {
      const xpath =
        "/html/body/app/div/div[2]/div[2]/div/az-compliance/az-content/div/page-header/div/div/div[1]/div[1]/div";
  ...
  window.fetch = async function (...args) {
    ...
    if (matchedEndpoint && response.ok) {
      ...
      try {
        ...
        log(`✓ [FETCH] ${matchedEndpoint.key} received`, {
    ...
    this.addEventListener("load", function () {
      ...
      if (matchedEndpoint && this.status === 200) {
        ...
        try {
          ...
          log(`✓ [XHR] ${matchedEndpoint.key} received`, {
            status: this.status,
